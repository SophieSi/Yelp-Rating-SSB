...
ScatterPlot.prototype.initVis = function() {
    ...
    vis.g.append('text')
        ...
        .attr("transform", "translate(" + 200 + "," + vis.height + ")");
    ...
    vis.xv = d3.scaleLinear()
        .range([ 0, vis.width])
        .domain([0,100]) // the largest possible number
        .nice();

    // vis.xv_axis = d3.svg.axis()
    //     .orient("bottom")
    //     .scale(vis.xv);
    //
    // vis.yv_axis = d3.svg.axis()
    //     .orient("left")
    //     .scale(vis.yv);
    ...
    //
    // vis.cell.append("title")
    //     .text(function(d) { return d.data.id + "\n" + vis.formatValue(d.data.value); });
}
...
ScatterPlot.prototype.updateVisViolin =  function (_newData) {
    ...
    vis.gPlus.attr("transform", "rotate(0,0,0)  translate(" + 200 + ",0)");
    vis.gMinus.attr("transform", "rotate(180,0,0) scale(1,-1) translate( -" + 200 + ",0)");
    ...
    //
    // var gPlus = vis.violin.append("g")
    // var gMinus = vis.violin.append("g")
    //
    // gPlus.append("path")
    //     .datum(vis.data)
    //     .attr("class", "area")
    ...
    //     .style("fill", "none");
    //
    // gPlus.attr("transform", "rotate(90,0,0)  translate(0,-"+vis.width+")");//translate(0,-200)");
...
ScatterPlot.prototype.updateVis = function(_newData) {
    ...
    // plot.selectAll('dots').exit().remove();
